...
?>
     ...
     <?php include_once('includes/header.php');?>
      ...
      <div class="container-fluid page-body-wrapper">
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Term 1 fee</th>
                            <th class="font-weight-bold">Term 2 fee</th>
                            <th class="font-weight-bold">Term 3 fee</th>
       ...
       $ret = "SELECT id FROM classes";
$query1 = $dbh -> prepare($ret);
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$total_rows=$query1->rowCount();
$total_pages = ceil($total_rows / $no_of_records_per_page);
$sql="SELECT * from classes LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
