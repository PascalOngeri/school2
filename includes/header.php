...
<html lang="en">
  <head>
    ...
    <title><?php echo  $_SESSION['name']; ?>|| Update About Us</title>
    <!-- plugins:css -->
...
{               ?>
        <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
          <h5 class="mb-0 font-weight-medium d-none d-lg-flex mx-auto"> infinity schools System Registered to <?php echo  $_SESSION['name']; ?> !</h5>
