...
$am=$lname+$em+$dob;
        ...
        $sql = "UPDATE bus SET area=:fname, t1=:lname, t2=:stuemail, t3=:dob,amount=:am WHERE id=:id";
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Edit Bus payment </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Edit Bus payment</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Update bus Payment</h4>
                   
                    <form class="forms-sample" method="post" enctype="multipart/form-data" action="editB.php">
                      <?php
 $eid = $_GET['editid'];
$sql="SELECT t1, t2, t3, amount, area,id From bus where id=:eid";
$query = $dbh -> prepare($sql);
...
{               ?>
   <input type="text" name="id" value="<?php  echo htmlentities($row->id);?>" class="form-control" hidden="true" >
                      <div class="form-group">
                        ...
                        <input type="text" name="fname" value="<?php  echo htmlentities($row->area);?>" class="form-control" required='true'>
                      </div>
